...
const Projects = () => {
  ...
  const getProjectTeam = (project) => {
    ...
    return teams.find((team) => team._id === project.team || team._id === selectedTeam);
  };
                      ...
                      {editingProject?._id === project._id ? (
                        ...
                        <>
                          ...
                          <div className="project-meta">
                            <p className="working-team">
                              <strong>Working team:</strong> {projectTeam?.name || 'Not assigned'}
                              {projectTeam?.members && ` (${projectTeam.members.length} members)`}
                            </p>
                            <p><strong>Created by:</strong> {getProjectCreatorName(project)}</p>
